...
// 	var jsonStr = []byte(`{"title":"title", "author":"author", "published_date":"2006-01-02", "image_url":"image_url", "description":"description"}`)

// 	req, err := http.NewRequest("POST", "/api/v1/books", bytes.NewBuffer(jsonStr))
// 	if err != nil {
// 		t.Fatal(err)
// 	}
...
// 	mockBookService.EXPECT().CreateBook(req.Context(), b).Return(bookDto, nil).AnyTimes()
